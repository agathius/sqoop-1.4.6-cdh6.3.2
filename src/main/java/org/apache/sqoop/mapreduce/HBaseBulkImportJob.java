...
public class HBaseBulkImportJob extends HBaseImportJob {
    ...
    protected void jobSetup(Job job) throws IOException, ImportException {
        ...
        Connection hbaseConnection = ConnectionFactory.createConnection(job.getConfiguration());
        TableName tableName = TableName.valueOf(options.getHBaseTable());
        RegionLocator regionLocator = hbaseConnection.getRegionLocator(tableName);
    ...
    protected void completeImport(Job job) throws IOException, ImportException {
        ...
        try {
            ...
            loader.doBulkLoad(bulkLoadDir, hbaseConnection.getAdmin(), hTable, regionLocator);
        } catch (Exception e) {
